      ...
      <div className='main'>
        <div className='sub p-5'>
          <div className='heading'>
            <img src="https://www.designnominees.com/application/upload/Apps/2017/01/bmi-calculator-weight-loss-169.png" alt="" />
          ...
          <div className='d-flex mt-4 '>
            <Button variant="contained" className='w-50 p-3 me-3' color='primary' disabled={isheight && isweight ? false : true} onClick={handleCalculate} >Calculate</Button>
            <Button variant="outlined" className='w-50 p-3' color='primary' onClick={handleReset}>Reset</Button>
          </div>
          <div className='w-100 d-flex justify-content-center align-items-center result  mt-3  flex-column'>
            <p className='pt-4 bmi text-primary'>Your BMI Is</p>
            <div className='bmi-result'><h1 className='pt-1 fs-2'>{BMI} </h1></div>
            <p  className='text-primary fs-3 '>{status}</p>
          </div>
